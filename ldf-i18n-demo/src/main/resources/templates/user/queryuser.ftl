...
<html lang="zh-CN">
  <head>
    ...
    <link href="${rc.contextPath}/service/webjars/ldf/css/flexgrid.css" rel="stylesheet">
    <link href="${rc.contextPath}/service/webjars/ldf/css/ui.css" rel="stylesheet">
    <link href="${rc.contextPath}/service/webjars/ldf/css/form.css" rel="stylesheet">
    <link href="${rc.contextPath}/service/css/index.css" rel="stylesheet">
    ...
    <![endif]-->
     ...
     <script src="${rc.contextPath}/service/webjars/ldf/js/bootstrap.js"></script>
     <script src="${rc.contextPath}/service/webjars/ldf/js/flexgrid.js"></script>
     <script src="${rc.contextPath}/service/webjars/ldf/js/loushang-framework.js"></script>
     <script src="${rc.contextPath}/service/webjars/ldf/js/form.js"></script>
     <script src="${rc.contextPath}/service/webjars/ldf/js/ui.js"></script>
	 <script src="${rc.contextPath}/service/js/queryuser.js"></script>
			...
			<form class="form-inline" onsubmit="return false;">										
			    ...
			    <div class="btn-group pull-right">
					<button id="add" type="button"
						class="btn ue-btn">
						<span class="fa fa-plus"></span><spring:message code="user.add" text="增加"/>
					</button>
